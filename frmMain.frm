...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame frmMousepointer 
      Caption         =   "M&ousepointer"
      Height          =   735
      Left            =   4680
      TabIndex        =   17
      Top             =   7920
   ...
   Begin VB.Frame frmParticles 
      ...
      Begin VB.OptionButton optType2 
         Caption         =   "Type 2 ( balls, very slow)"
         Height          =   375
         Left            =   240
         TabIndex        =   14
         Top             =   480
...
'Refresh Mouspointer Position, When Shift is pressed move the orign
Private Sub OUTPUT_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    
    lblPointer.Caption = "Position ( " & X & " / " & Y & " )"
